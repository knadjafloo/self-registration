...
class Signup extends Component {
    ...
    render() {
        const federated = {
            google_client_id: '81630869668-cpd5r0vo0uaeifnm0358s8mgcis2b5uc.apps.googleusercontent.com',
            ...
            <div>
                <span>
                    <form name="registerform" onSubmit={this.handleSubmit}>
                        <div>
                            {this.renderError()}
                            <FormElement name="email" type="email" label="Email" placeholder="jane.doe@example.com" handleChange={this.handleChange} autoFocus />
